      ...
      <div className="mt-4 mb-24">
        <div className="premium-card p-4 mb-6">
          <p className="text-gray-300 mb-4">
            {status?.status === 'done' 
              ? "Ваш результат создан с помощью ИИ" 
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {status?.status === 'done' && status.videoUrl ? (
            <button 
              ...
              className="gradient-bg hover:opacity-90 transition-all text-center py-3 rounded-xl font-medium flex items-center justify-center"
            >
