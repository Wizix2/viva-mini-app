    ...
    <header className="w-full px-4 sm:px-6 py-5 flex items-center justify-between max-w-screen-md mx-auto">
      <div className="flex items-center">
        {showBackButton && (
          <Link 
            href={backUrl} 
            className="mr-4 text-gray-400 hover:text-white transition-all duration-200 flex items-center justify-center w-8 h-8 rounded-full hover:bg-dark-100 hover:scale-105"
          >
        ...
        {isHomePage ? (
          <div className="flex flex-col animate-fadeInScale">
